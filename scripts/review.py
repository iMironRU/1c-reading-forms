...
#
# Имя должно быть из списка, который отдаёт GET /v1/models. Здесь стояло
# «gpt-5.5» — такой модели у провайдера нет, и вызов упал бы с 404. Пока на
# счёте не было кредитов, ошибка кредитов приходила раньше и эту прятала.
